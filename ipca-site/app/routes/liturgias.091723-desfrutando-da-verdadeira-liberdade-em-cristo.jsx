      ...
      <div className="slides">
        ...
        <section data-background={getAssetUrl("ipcachoeirinha/cruz-wallpaper-light")}>
          ...
          <ul className="list-disc text-left mt-2">
            ...
            <li class="text-green-800 text-5xl mb-8 tracking-wider"><span class="font-bold">ORAÇÃO DE
              ADORAÇÃO</span></li>
            <li class="text-green-800 text-5xl mb-8 tracking-wider"><span class="font-bold">HINO:</span> TESTEMUNHO,
              nº 386</li>
          </ul>
        </section>
        ...
        <section data-background={getAssetUrl("ipcachoeirinha/cruz-wallpaper-light")}>
          ...
          <ul className="list-disc text-left mt-2">
            ...
            <li class="text-green-800 text-5xl mb-8 tracking-wider"><span class="font-bold">ORAÇÃO DE GRATIDÃO</span></li>
            <li class="text-green-800 text-5xl mb-8 tracking-wider"><span class="font-bold">HINO:</span> ESPÍRITO DO ETERNO DEUS, nº 86</li>
          </ul>
        </section>
        ...
        <section data-background={getAssetUrl("ipcachoeirinha/cruz-wallpaper-light")}>
          ...
          <ul className="list-disc text-left mt-2">
            <li class="text-green-800 text-5xl mb-8 tracking-wider"><span class="font-bold">HINO:</span> MAIS DE CRISTO, nº 135</li>
            <li class="text-green-800 text-5xl mb-8 tracking-wider"><span class="font-bold">CONSAGRAÇÃO DE DÍZIMOS E OFERTAS</span></li>
