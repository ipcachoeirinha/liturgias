...
<SlideWithBackground><section className="bg-zinc-50">
  <p className="text-black text-[84px] font-bold text-left leading-none mb-12">Eu sei que foi pago um alto preço</p>
  <p className="text-black text-[84px] font-bold text-left leading-none mb-12">Para que contigo eu fosse um, meu irmão</p>
  <p className="text-black text-[84px] font-bold text-left leading-none mb-12">Quando Jesus derramou Sua vida</p>
  <p className="text-black text-[84px] font-bold text-left leading-none mb-12">Ele pensava em ti, Ele pensava em mim</p>
  <p className="text-black text-[84px] font-bold text-left leading-none mb-12">Pensava em nós</p>
</section>

<section className="bg-zinc-50">
  <p className="text-black text-[84px] font-bold text-left leading-none mb-12">E nos via redimidos por Seu sangue</p>
  <p className="text-black text-[84px] font-bold text-left leading-none mb-12">Lutando o bom combate do Senhor</p>
  <p className="text-black text-[84px] font-bold text-left leading-none mb-12">Lado a lado trabalhando</p>
  <p className="text-black text-[84px] font-bold text-left leading-none mb-12">Sua igreja edificando</p>
  <p className="text-black text-[84px] font-bold text-left leading-none mb-12">E rompendo as barreiras pelo amor</p>
</section>

<section className="bg-zinc-50">
  <p className="text-black text-[84px] font-bold text-left leading-none mb-12">E na força do Espírito Santo</p>
  <p className="text-black text-[84px] font-bold text-left leading-none mb-12">Nós proclamamos aqui</p>
  <p className="text-black text-[84px] font-bold text-left leading-none mb-12">Que já foi pago o preço de sermos</p>
  <p className="text-black text-[84px] font-bold text-left leading-none mb-12">Um só coração no Senhor</p>
</section>

<section className="bg-zinc-50">
  <p className="text-black text-[84px] font-bold text-left leading-none mb-12">E por mais que as trevas militem</p>
  <p className="text-black text-[84px] font-bold text-left leading-none mb-12">E nos tentem separar</p>
  <p className="text-black text-[84px] font-bold text-left leading-none mb-12">Com os nossos olhos em Cristo</p>
  <p className="text-black text-[84px] font-bold text-left leading-none mb-12">Unidos iremos andar.</p>
</section></SlideWithBackground>
